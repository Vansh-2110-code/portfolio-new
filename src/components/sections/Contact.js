...
export default function Contact() {
  ...
  const copyEmail = () => {
    navigator.clipboard.writeText('vanshgoyal1021@gmail.com').catch(() => {});
    setCopiedEmail(true);
    ...
    <ContactSection id="contact">
      ...
      <ContactContainer>
        ...
        <SectionTitle>
          ...
          <TitleLine2>{t('contact.title2') || "intelligent."}</TitleLine2>
        </SectionTitle>

        <SectionSub>{t('contact.subtitle') || "Have an AI/ML project or software development role? I'd love to hear about it."}</SectionSub>
        ...
        <ContactLayout>
          ...
          <LeftPanel>
            <StatusBadge>
              <StatusDot />
              {t('contact.availableStatus') || "Open for opportunities"}
            </StatusBadge>
            ...
            <ContactInfoCards>
              <InfoCard onClick={copyEmail} $isRTL={isRTL}>
                ...
                <InfoCardContent>
                  ...
                  <InfoCardValue>
                    {copiedEmail ? <span style={{ color: '#10b981' }}>{t('contact.copiedSucc') || 'Copied ✓'}</span> : 'vanshgoyal1021@gmail.com'} 
              ...
              <InfoCard $isRTL={isRTL}>
                ...
                <InfoCardContent>
                  ...
                  <InfoCardValue>{t('contact.locationValue') || 'Indore, India 🇮🇳'}</InfoCardValue>
                </InfoCardContent>
              </InfoCard>
            </ContactInfoCards>
            ...
            <SocialsRow>
              <SocialBtn href="https://github.com/Vansh-2110-code" target="_blank" title="GitHub">
                <FaGithub />
              </SocialBtn>
              <SocialBtn href="https://www.linkedin.com/in/vanshgoyal/" target="_blank" title="LinkedIn">
                <FaLinkedinIn />
              </SocialBtn>
            </SocialsRow>
          </LeftPanel>
