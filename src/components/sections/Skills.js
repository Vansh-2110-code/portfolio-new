  ...
  return (
    <SectionWrapper id="skills" label={t('skills.label')} title={t('skills.title')} description={t('skills.description')}>
      <BentoGrid>
        ...
        {/* 1. Machine Learning & AI (Spans 2 columns) */}
        <BentoCard spanCols={2} flexRowMd>
          <div style={{ flex: '1', zIndex: '20', display: 'flex', flexDirection: 'column', height: '100%', justifyContent: 'center' }}>
            ...
            <TechTags>
              {['Python', 'TensorFlow', 'Scikit-learn', 'Deep Learning', 'Gemini API'].map(tech => (
        ...
        <BentoCard spanCols={1} spanRows={2}>
          ...
          <TechTags>
            {['Next.js', 'PostgreSQL', 'SQL', 'Docker', 'Astra CRM', 'ATS'].map(tech => (
              <TechTag key={tech}>{tech}</TechTag>
            ))}
          </TechTags>
        </BentoCard>

        {/* 3. Data Analytics & Power BI (Spans 2 columns) */}
        <BentoCard spanCols={2} flexRowMd>
          <div style={{ flex: '1', zIndex: '20', display: 'flex', flexDirection: 'column', height: '100%', justifyContent: 'center' }}>
            ...
            <TechTags>
              {['Pandas', 'NumPy', 'Power BI', 'EDA', 'Scapy', 'React Native'].map(tech => (
                <TechTag key={tech}>{tech}</TechTag>
              ))}
            </TechTags>
          </div>
