...
export default function Hero() {
  ...
  /* ── 12 Badges Config ── */
  const BADGES = [
    { name: 'Python', emoji: '🐍', color: '#3776AB', percent: '95%' },
    { name: 'TensorFlow', emoji: '🧠', color: '#FF6F00', percent: '92%' },
    { name: 'Scikit-learn', emoji: '⚙️', color: '#F7931E', percent: '90%' },
    { name: 'Next.js', emoji: '▲', color: '#a0a0a0', percent: '90%' },
    { name: 'Power BI', emoji: '📊', color: '#F2C811', percent: '92%' },
    { name: 'Pandas', emoji: '🐼', color: '#150458', percent: '95%' },
    { name: 'React Native', emoji: '📱', color: '#61DAFB', percent: '85%' },
    { name: 'SQL', emoji: '🗄️', color: '#336791', percent: '90%' },
    { name: 'C++', emoji: '⚡', color: '#00599C', percent: '88%' },
    { name: 'Gemini API', emoji: '✨', color: '#8E75FF', percent: '90%' },
    { name: 'Scapy & Sec', emoji: '🛡️', color: '#06B6D4', percent: '88%' },
    { name: 'Docker', emoji: '🐳', color: '#2496ED', percent: '80%' },
  ];
    ...
    <HeroSection id="hero" ref={heroRef}>
      ...
      <HeroContainer>
        ...
        <TextColumn ref={textColumnRef}>
          ...
          <RoleWrapper>
            <RoleLine />
            <RoleText>Machine Learning & Full-Stack Developer</RoleText>
          </RoleWrapper>
          ...
          <SocialLinks>
            <SocialIcon href="https://github.com/Vansh-2110-code" target="_blank" rel="noopener noreferrer"><FiGithub /></SocialIcon>
            <SocialIcon href="https://www.linkedin.com/in/vanshgoyal/" target="_blank" rel="noopener noreferrer"><FiLinkedin /></SocialIcon>
          </SocialLinks>
        </TextColumn>
        ...
        <AvatarColumn ref={avatarColumnRef}>
          <AvatarWrapper ref={avatarRef}>
            ...
            <AvatarFrame
              ref={frameImgRef}
              role="img"
              aria-label="Vansh Goyal 3D Avatar"
            />
          </AvatarWrapper>
        </AvatarColumn>
