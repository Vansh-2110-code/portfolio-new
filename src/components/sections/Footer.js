    ...
    <FooterSection>
      ...
      <CtaArea>
        ...
        <CtaButtons>
          ...
          <MagneticButton>
            <CtaBtnOutline href="https://github.com/Vansh-2110-code" target="_blank">
              <FaGithub /> GitHub
            </CtaBtnOutline>
          </MagneticButton>
        </CtaButtons>
      ...
      <FooterBody>
        <FooterInner>
          ...
          <BrandCol>
            ...
            <FooterSocials>
              <SocialBtn href="https://github.com/Vansh-2110-code" target="_blank" title="GitHub"><FaGithub /></SocialBtn>
              <SocialBtn href="https://www.linkedin.com/in/vanshgoyal/" target="_blank" title="LinkedIn"><FaLinkedinIn /></SocialBtn>
            </FooterSocials>
          </BrandCol>
          ...
          <StatusCard>
            ...
            <StatusBadge><GreenDot /> {t('contact.availableStatus') || 'Open for opportunities'}</StatusBadge>
            <EmailRow><FiMail size={12} /> vanshgoyal1021@gmail.com</EmailRow>
